...
SEASONAL_NOUNS = {
    ...
    'winter' => ['Snowman', 'Snow Woman', 'Jingle Bell', 'Christmas Tree', 'Dreidel', 'Menorah', 'Sock', 'Gelt', 'Latke', 'Mitzvah','Candle', 'Candy Cane', 'Stocking', 'Snowflake', 'Sleigh', 'Christmas Carol', 'Sugar Plum', 'Nutcracker', 'Plum Pudding','Icicle','Snowboard','Angel', 'Yule', 'Elf']
}

['Wil Wheaton',"Obama", "The FBI", "Bill Maher", "Bill O'Reilly", "Ann Coulter", "Rush Limbaugh", "Glenn Beck","Vladimir Putin", "The CIA", "They"].each do |n|
  newnoun = Noun.find_or_initialize_by(value: n)
  newnoun.is_agent = true
...
['Low-Carb Lunch', 'Book', 'Photo', 'Movie', 'Rumor', 'Conspiracy Theory', 'Sign', 'Country', 'City', 'House','Observation', 'Interview Question', 'Fashion Mistake','Recycling Mistake', 'Felony','Stunning Things','Reason', 'Idea', 'Secret','Explanation','Pachenko Game','Fortune Teller','Circus'].each do |n|
...
["Take Over", "Keep", "Live By", "Tell Anyone About", "Reveal", "Steal", "Befriend", "Run Into", "Marry", "Know", "Answer", "Feel", "Approach", "Run Away From", "Taste", "Watch", "Smell", "Hear", "See", "Be Rescued From",'Be Stunned By','Snog'].each do |v|
