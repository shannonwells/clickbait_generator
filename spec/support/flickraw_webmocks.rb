module FlickrawWebmocks
  ...
  def mock_oauth
    oauth_token_response = {"auth": {
        "access_token": {"oauth_token": "72157681967237936-345339bba683705b", "oauth_token_secret": "dcd648afd3de3cfb"}}, "stat": "ok"}
    stub_request(:post, "https://api.flickr.com/services/oauth/request_token").
        to_return(:status => 200, :body => JSON.generate(oauth_token_response), :headers => {})
  end

  def mock_get_methods
    ...
    stub_request(:post, "https://api.flickr.com/services/rest/").
        ...
        to_return(:status => 200, :body => JSON.generate(reflection_get_methods), :headers => {})
